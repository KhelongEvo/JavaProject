...
public class TChoice extends JFrame {
...
//				System.out.println(getItemName());
				if (eachItemName == "BrewedTea" || eachItemName == "Cloud&Mint" || eachItemName == "HoneyMintTea" || eachItemName == "ChaiLatte" ||
					...
					teaTransaction.recordData(teaInventory.getSelectItemName(), quantity, getOptionAmount(), getOptionAmount()*quantity);
					...
					dessertTransaction.connectionSQLite();
					dessertTransaction.recordData(dessertInventory.getSelectItemName(), quantity, getOptionAmount(), getOptionAmount()*quantity);
...
//					System.out.println(quantity);
		...
		hotBtn.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				setTypeCoffee("hot");
				setOptionAmount((float) 1.50);
//				System.out.println(typeCoffee);
//				System.out.println(optionAmount);
			}
		});
		hotBtn.setText("Small - $1.50");
